...
class Ui_AddApplicationDialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_employee)
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.comboBox_employee)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Добавить заявку"))
        self.label_title.setText(_translate("Dialog", "Добавление заявки"))
        self.label_user.setText(_translate("Dialog", "Пользователь:"))
        self.label_employee.setText(_translate("Dialog", "Сотрудник:"))
