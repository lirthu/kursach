...
class Ui_EditProductDialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_brand)
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.lineEdit_brand)
