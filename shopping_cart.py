...
class Ui_Cart_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout_2.setContentsMargins(780, -1, 20, -1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "20"))
        self.label_4.setText(_translate("Form", "руб"))
        self.pushButton_7.setText(_translate("Form", "Оформить заказ"))
        self.pushButton_5.setText(_translate("Form", "Сохранить изменения"))
